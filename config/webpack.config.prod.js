...
module.exports = {
  ...
  resolve: {
    ...
    extensions: ['.web.js', '.mjs', '.js', '.json', '.web.jsx', '.jsx', '.ts', '.web.tsx', '.tsx'],
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      scripts: [
        ...
        '//cdn.bootcss.com/react/16.13.0/umd/react.production.min.js',
        '//cdn.bootcss.com/react-dom/16.13.0/umd/react-dom.production.min.js',
        '//cdn.bootcdn.net/ajax/libs/react-router-dom/5.1.2/react-router-dom.min.js',
      ],
      inject: true,
